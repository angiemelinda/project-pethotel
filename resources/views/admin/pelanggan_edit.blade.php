...
<head>
    ...
    <title>Edit Pelanggan - Admin Pet Hotel</title>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-indigo-100">Perbarui informasi pelanggan {{ $pelanggan->nama }}</p>
                </div>
            ...
            <form action="{{ route('admin.pelanggan.update', $pelanggan->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="telepon" id="telepon" 
                           ...
                           placeholder="081234567890" pattern="[0-9]{10,12}" minlength="10" maxlength="12" required>
                    @error('telepon')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
