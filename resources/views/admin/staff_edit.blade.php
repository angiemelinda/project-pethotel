...
<head>
    ...
    <title>Edit Staff - Pet Hotel</title>
...
<body class="gradient-bg min-h-screen py-8 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-white mb-2">Edit Staff</h1>
            <p class="text-indigo-100">Update informasi staff {{ $staff->nama }}</p>
        </div>
            ...
            <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="jabatan" 
                        ...
                        <option value="Receptionist" {{ $staff->jabatan == 'Receptionist' ? 'selected' : '' }}>Receptionist</option>
                        <option value="Pet Groomer" {{ $staff->jabatan == 'Pet Groomer' ? 'selected' : '' }}>Pet Groomer</option>
                        <option value="Veterinarian" {{ $staff->jabatan == 'Veterinarian' ? 'selected' : '' }}>Veterinarian</option>
                        <option value="Pet Sitter" {{ $staff->jabatan == 'Pet Sitter' ? 'selected' : '' }}>Pet Sitter</option>
                        <option value="Cleaner" {{ $staff->jabatan == 'Cleaner' ? 'selected' : '' }}>Cleaner</option>
