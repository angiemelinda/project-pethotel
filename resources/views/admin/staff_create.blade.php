...
<head>
    ...
    <title>Tambah Staff - Pet Hotel</title>
...
<body class="gradient-bg min-h-screen py-8 px-4">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-white mb-2">Tambah Staff</h1>
            <p class="text-indigo-100">Kelola data staff baru untuk sistem Pet Hotel</p>
        </div>
